...
const Login = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#F5EFEA] overflow-hidden relative">
      <div className="container h-auto md:h-screen flex flex-col md:flex-row items-center justify-center px-4 md:px-20 mx-auto py-10 md:py-0">
        {/* Left side: image */}
        ...
        <div className="w-full md:w-2/4 h-auto md:h-[80vh] bg-white rounded-lg md:rounded-r-lg relative p-8 md:p-16 shadow-lg">
          <form
